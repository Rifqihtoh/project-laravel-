	 ...
	 <div class="container">
	 	...
	 	<div class="row">
		  ...
		  <div class="col-sm-6">
		    <div class="card">
		      <div class="card-body">
		        <h5 class="card-title">Never Give Up! and Do Your Best!</h5>
		        <p class="card-text">You must tell yourself, no matter how hard it is, or how hard it gets, i'm going to make it. ~Les Brown</p>
		        <a href="{{route('user.details')}}" class="btn btn-primary">Show Profile</a>
		      </div>
		    </div>
		  </div>
		</div>
