    ...
    <div class="row">
      ...
      <div class="col-sm-6">
        <h1 class="mt-3">Form update user</h1>
         <form method="post" action="{{route('user.update.desc')}}">
          @csrf
          @method('PUT')
          <div class="mb-3">
            <div>User description:</div>
            <div class="form-floating">
              <textarea class="form-control" placeholder="Masukkan deskripsi user" id="userdesc" name="User_desc" value="{{$user->User_desc}}"></textarea>
