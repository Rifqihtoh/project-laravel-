       ...
       <div class="col-6">
         ...
         <div class="card" style="width: 18rem;">
          ...
          <ul class="list-group list-group-flush">
            ...
            <li class="list-group-item">Status: {{$event->Ev_status}}</li>
          ...
          <div class="card-body">
            ...
            <a href="{{route('events.edit',$event->Ev_id)}}" class="btn btn-primary">edit</a>
            <form action="{{route('events.destroy',$event->Ev_id)}}" method="post" class="d-inline">
              @method('delete')
              @csrf
